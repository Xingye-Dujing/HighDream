...
- [**BaseManualStepSolver**](core/base_manual_step_solver.py) — 手动规则选择的基础编排器，封装了各领域共用的选择/回退/状态管理逻辑
- [**MethodTreeEnumerator**](core/method_tree_enumerator.py) — 全规则遍历方法树的核心枚举器，递归展开所有可应用规则分支
